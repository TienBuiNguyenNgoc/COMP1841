...
$subject = isset($_GET['subject']) ? strtoupper($_GET['subject']) : 'BUSI';
...
?>
  <div class="container">
    <div class="section-header">
      <div class="category-title">BUSI</div>
      <a href="BA_business.php" class="view-all" style="color: #fff;">VIEW ALL <i class="bi bi-caret-right-fill"></i></a>
    </div>

    <div class="subheading" style="color: #fff;">Popular subjects in BUSI</div>

    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-6 g-4">
      <?php foreach ($modules as $module): ?>
        <div class="col">
          <div class="card movie-card">
            <img src="img_bg/busi.jpg" class="card-img-top" alt="<?= htmlspecialchars($module['modulename']) ?>">
        ...
        <div class="col-md-6">
          <div class="card news-card">
            <div class="position-relative">
              <img src="img_bg/busi.jpg" class="card-img-top" alt="<?= htmlspecialchars($topic['modulename']) ?>">
