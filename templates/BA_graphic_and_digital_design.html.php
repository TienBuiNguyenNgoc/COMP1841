    ...
    <div class="container">
      ...
      <div class="section-header">
        ...
        <div class="container mt-4">
            <?php if (count($desis) > 0): ?>
                <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4">
                    <?php foreach ($desis as $desi): ?>
                        <div class="col">
                            <div class="card movie-card shadow-sm">
                                <img src="img_bg/desi.jpg" 
                                    class="card-img-top" 
                                    alt="<?= htmlspecialchars($desi['Subject']) ?> Module Image">

                                <div class="card-body" style="color: #fff;">
                                    <h5 class="card-title mb-2"><?= htmlspecialchars($desi['Modulecode']) ?></h5>
                                    <p class="card-subtitle" style="color: #fff;">
                                        <i class="bi bi-book"></i> <?= htmlspecialchars($desi['Modulename']) ?>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <?php else: ?>
                <p class="text-center text-muted mt-3">No DESI modules found.</p>
            <?php endif; ?>
        </div>
        <script src="img_bg/desi.jpg"></script>
    </div>
